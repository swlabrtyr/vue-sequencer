...
<div>
  ...
  <div> 
    ...
    <Slider
      ...
      :increment="0.01"
      id="delayFB"
      v-on:slider-updated="updateDelayFB"></Slider>
  </div>
<div>
    Amp
    <Slider
      ...
      :increment="0.01"
      id="delayAmp"
      v-on:slider-updated="updateDelayAmp"></Slider>
  </div>
</div>
</template>
...
export default {
  ...
  methods: {
    ...
    updateDelayAmp: function(sliderData) {
      this.$store.commit("setDelayAmp", sliderData);
    },
